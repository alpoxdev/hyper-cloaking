...
export const youtubeSelectors = {
  ...
  video: {
    ...
    description: {
      ...
      fallback: 'ytd-watch-metadata #description-inline-expander, ytd-text-inline-expander#description-inline-expander'
    },
    viewCount: {
    ...
    commentText: {
      primary: '[role="article"][aria-label*="comment" i] #content-text, [role="article"] [data-testid="comment"]',
  ...
  channel: {
    name: {
      primary: 'h1[role="heading"]',
      fallback: 'ytd-channel-name #text, ytd-c4-tabbed-header-renderer #channel-header-container #text'
    },
    handle: {
    ...
    videoLinks: {
      primary: 'a[aria-label][href^="/watch?v="]',
      fallback: 'ytd-rich-grid-media a#video-title-link[href^="/watch?v="], ytd-grid-video-renderer a#video-title'
    },
    emptyState: {
  ...
  actions: {
    likeButton: {
      primary: 'ytd-watch-metadata ytd-segmented-like-dislike-button-renderer button[aria-label^="Like this video" i], ytd-watch-metadata ytd-segmented-like-dislike-button-renderer button[aria-label^="Unlike" i]',
      fallback: 'ytd-watch-flexy ytd-segmented-like-dislike-button-renderer button[aria-label^="Like this video" i], ytd-watch-flexy ytd-segmented-like-dislike-button-renderer button[aria-label^="Unlike" i]'
    },
    commentField: {
      primary: 'ytd-comments ytd-comment-simplebox-renderer [role="textbox"][aria-label*="comment" i]',
    ...
    commentEmptyState: {
      ...
      fallback: 'ytd-comments #contents:not(:has(ytd-comment-thread-renderer, ytd-comment-view-model, ytd-comment-renderer))'
    },
    subscribeButton: {
      primary: 'ytd-c4-tabbed-header-renderer ytd-subscribe-button-renderer button[aria-label^="Subscribe" i], ytd-c4-tabbed-header-renderer ytd-subscribe-button-renderer [role="button"][aria-label^="Subscribe" i]',
