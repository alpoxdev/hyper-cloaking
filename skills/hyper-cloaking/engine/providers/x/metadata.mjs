// X (formerly Twitter) provider metadata only. `t.co` is a redirect
...
export const xProvider = {
  ...
  metadata: {
    category: 'social',
    notes: 'X (formerly Twitter) social platform including the bare x.com host, legacy twitter.com hosts, and the mobile host.'
  },
  domains: {
    primary: 'x.com',
