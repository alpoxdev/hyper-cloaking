...
export { humanClick, humanMove } from './mouse.mjs';
export {
...
export { evaluateOutcome, makeOutcomeReport } from './outcome.mjs';
export { classifyChallengeObservation, makeFailureDiagnostic } from './diagnostics.mjs';
export {
...
export { appendRunShape, clearRunShapes, sanitizeRunShape } from './run-shapes.mjs';
 ...
 */
export function buildNoSandboxWarningSafeCloakOptions(
  cloakBrowser,
  options = {},
  launchOptions = {}
) {
  ...
  const defaultStealthArgs =
    cloakOptions.stealthArgs === false
      ? []
 ...
 */
export async function runBrowserUtilsCli(argv = process.argv.slice(2)) {
  const args = argv;
