...
export const instagramSelectors = {
  ...
  posts: {
    ...
    commentSubmit:
      'main article div[role="button"]:has-text("Post"), main article button[type="submit"]:has-text("Post")',
  ...
  dm: {
    ...
    emptyInboxState:
      'main h2:has-text("No messages"), main [role="status"]:has-text("No messages")',
    emptyThreadState:
      'main h2:has-text("No messages yet"), main [role="status"]:has-text("No messages yet")',
