...
export const tiktokSelectors = {
  user: {
    ...
    emptyState:
      'main [role="status"]:has-text("No videos"), main [role="status"]:has-text("게시물이 없습니다")'
  },
  video: {
    ...
    comment:
      'main textarea[data-e2e="comment-input"], main [contenteditable="true"][data-e2e="comment-input"]',
    commentSubmit: 'main button[data-e2e="comment-post"]',
    commentText: 'main [data-e2e="comment-level-1"] [data-e2e="comment-text"]',
    commentEmptyState:
      'main [role="status"]:has-text("No comments"), main [role="status"]:has-text("댓글이 없습니다")',
    reply: 'button[data-e2e="comment-reply"]'
  },
  search: {
    videoLink: 'main a[href*="/video/"]',
    emptyState:
      'main [role="status"]:has-text("No results"), main [role="status"]:has-text("검색 결과가 없습니다")'
  },
  dm: {
    ...
    composer:
      'main [contenteditable="true"][data-e2e="message-input"], main textarea[placeholder*="message"]',
